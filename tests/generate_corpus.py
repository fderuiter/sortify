...
def create_large_corpus(num_docs=500):
    ...
    categories = {
        "Health": ["medical", "science", "healthcare", "doctor", "patient", "clinical", "hospital", "medicine", "treatment", "disease", "wellness", "therapy", "surgery"],
        "Finance": ["finance", "money", "investment", "banking", "market", "stock", "economy", "trade", "capital", "revenue", "profit", "loss", "assets", "bonds"],
        "Tech": ["software", "engineering", "computer", "algorithm", "technology", "hardware", "microchips", "data", "network", "code", "programming", "cloud", "security", "ai"],
        "Science": ["physics", "chemistry", "biology", "laboratory", "experiment", "research", "molecule", "quantum", "astronomy", "genetics", "theory", "discovery"]
    }
