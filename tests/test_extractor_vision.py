...
def test_extract_image_success(mocker):
    ...
    mock_model = MagicMock(return_value=[{"generated_text": "a screenshot of a dashboard"}])
    mocker.patch("app.core.extractor_strategies.get_vision_model", return_value=mock_model)
