    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        try:
            with Client(None):
                ...
                db.upsert_document(temp_dir, nested_filepath, "hash123", "Content of nested file")
                ...
                event_negative = MockEvent("Folder/Subfolder/nested_file.txt", "negative")
                ...
                removed_info = find_and_remove_file(app.plan, "Folder/Subfolder/nested_file.txt")
