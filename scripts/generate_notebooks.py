...
def main():
    ...
    with open(notebooks_dir / "01_ml_analyzer_clustering.ipynb", "w", encoding="utf-8") as f:
    ...
    with open(notebooks_dir / "02_multi_format_text_extraction.ipynb", "w", encoding="utf-8") as f:
    ...
    with open(notebooks_dir / "03_virtual_sorting_verification.ipynb", "w", encoding="utf-8") as f:
