...
Before any files are moved, the `core.verifier` ensures the sorting plan is safe and valid. The `VerificationEngine` proactively checks for execution errors:
