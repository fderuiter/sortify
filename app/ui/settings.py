...
class TokenWidget(ctk.CTkFrame):
    ...
    def __init__(self, master, tokens, on_change=None, **kwargs):
        ...
        self.entry = ctk.CTkEntry(self, placeholder_text="Type word and press Enter to add to exclusion list...")
    ...
    def _render_tokens(self):
        ...
        for i, word in enumerate(sorted(self.tokens)):
            ...
            frame = ctk.CTkFrame(self.scroll_frame, fg_color=("gray75", "gray30"), corner_radius=15)
...
class SettingsView(ctk.CTkFrame):
    ...
    def __init__(self, master, settings, on_back, on_settings_changed, **kwargs):
        ...
        back_btn = ctk.CTkButton(header_frame, text="← Back", width=60, command=self.on_back)
        back_btn.pack(side="left")
        
        title = ctk.CTkLabel(header_frame, text="Settings - Exclusion List", font=("Roboto", 20, "bold"))
        ...
        self.token_widget = TokenWidget(self, self.settings.STOP_WORDS, on_change=on_settings_changed)
