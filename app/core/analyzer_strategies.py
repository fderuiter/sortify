...
try:
    ...
    class LogitsProcessor:
        """Fallback LogitsProcessor class when transformers is not installed."""

        pass

    class LogitsProcessorList(list):
        """Fallback LogitsProcessorList class when transformers is not installed."""
...
class NegativeLogitBiasProcessor(LogitsProcessor):
    ...
    def __call__(self, input_ids, scores):
        """Apply negative logit bias during token selection."""
